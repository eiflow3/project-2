...
* **Screens (`lib/presentation/screens/`)**
  ...
  - [dashboard_screen.dart](file:///Users/michaeljosephsantos/Desktop/personal-projects/project-2/lib/presentation/screens/dashboard_screen.dart) - Home viewport. Displays professional slate charts, metric progress bars, top products tables, and aggregate data counters.
  - [order_entry_screen.dart](file:///Users/michaeljosephsantos/Desktop/personal-projects/project-2/lib/presentation/screens/order_entry_screen.dart) - Point of Sale checkout form. Calculates computed price in real-time, displays live stock indicator pills, and validates constraints.
  - [orders_list_screen.dart](file:///Users/michaeljosephsantos/Desktop/personal-projects/project-2/lib/presentation/screens/orders_list_screen.dart) - Sales transaction tracker database with custom filters, interactive sorting, and state change trigger sheets.
  - [products_list_screen.dart](file:///Users/michaeljosephsantos/Desktop/personal-projects/project-2/lib/presentation/screens/products_list_screen.dart) - Inventory command panel. Supports products editing, addition, deletion, and search.
